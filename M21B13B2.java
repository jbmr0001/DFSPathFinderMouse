 ...
 *
 */
public class M21B13B2 extends Mouse {
    ...
    */
    ...
    /**
     * Boolean que indica si se puede poner una bomba.
     * Se reinicia cada vez que nace un queso o el ratón muere
     */
    boolean bomba=true;
    ...
    public int move(Grid currentGrid, Cheese cheese){
        ...
        //Estrategia de bombas
        //Si estamos en una casilla cercana al queso lanzamos bomba
        if(currentGrid.getX()==cheese.getX() && currentGrid.getY() + 1 == cheese.getY()&& bomba ==true){
            bomba = false;
            return Mouse.BOMB;
        }
        if(currentGrid.getX()==cheese.getX() && currentGrid.getY() - 1 == cheese.getY()&& bomba ==true){
        ...
        if(currentGrid.getY()==cheese.getY() && currentGrid.getX() + 1 == cheese.getX()&& bomba ==true){
            bomba = false;
            return Mouse.BOMB;
        }
        if(currentGrid.getY()==cheese.getY() && currentGrid.getX() - 1 == cheese.getX()&& bomba ==true){
    ...
    private void dfs(Grid actual, Cheese cheese,int mov) {
        ...
        if(!encontrado){
            ...
            for(int i=0;i<lista.size();i++){
                ...
                if(!celdasVisitadasDFS.containsKey(clav)){// si no está visitado
                    dfs(lista.get(i),cheese,listaMov.get(i));
                }
            }
