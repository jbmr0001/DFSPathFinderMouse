 ...
 * 
 */
public class M21B13B1 extends Mouse {
    ...
    /**
     * Tabla hash para almacenar las celdas visitadas temporalmente por el
     * ratón: Clave:Coordenadas Valor: La celda. Se reinicia en caso de que el
     * ratón muera, la pila pilaMovimientos esté vacía o no haya ningún
     * movimiento posible.
     */
    ...
    /**
     * Lista para almacenar los movimientos del camino encontrado con el DFS en
     * su procesamiento.
     */
    private final LinkedList<Integer> movimientosBusqueda;

    /**
     * Lista para almacenar los movimientos del camino encontrado con el DFS
     * para su uso en el move.
     */
    ...
    //Entero contador para saber cuándo ha pasado un tiempo y puede colocar bombas
    private int contador;

    // Entero contador de los movimientos posibles.
    private int contaMovPos;
    ...
    public int move(Grid currentGrid, Cheese cheese) {
        ...
        //Comprobamos que el contador sea menor o igual que 0 en cuyo caso habrán pasado suficientes pasos cómo para poner otra bomba
        if (contador <= 0) { //reiniciamos el contador de movimientos posibles
            contaMovPos=0; //En caso de estar en un cruce de 4 caminos pondremos bomba directamente y reiniciamos el contador
            if (currentGrid.canGoUp() && currentGrid.canGoDown() && currentGrid.canGoLeft() && currentGrid.canGoRight()) {
                contador = 10;
                return Mouse.BOMB;
            } else { //En caso de estar en un cruce de 3 caminos ponemos bomba y se reinicia el contador
    ...
    /**
     * @brief Método que se llama cuando el raton pisa una bomba reinicia la
     * pila de movimientos y el mapa de las celdas temporales.
     */
    @Override
